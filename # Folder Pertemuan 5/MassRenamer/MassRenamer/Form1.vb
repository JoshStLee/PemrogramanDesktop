...
Public Class Form1
    ...
    Private Sub BtnPreview_Click(sender As System.Object, e As System.EventArgs) Handles BtnPreview.Click
        ...
        ElseIf mode = "IA" Then 'insert after F
            For i As Integer = 0 To arrFile2.Count - 1
                ...
                lvPreview.Items.Item(i).Text = Trim(arrFile2(i))
            Next
        ElseIf mode = "LC" Then 'Left crop n char F If (t.Text <> "" Or Val(t.Text) > 0) Then
    ...
    Private Sub BtnRename_Click(sender As Object, e As EventArgs) Handles BtnRename.Click
        ...
        For i As Integer = 0 To lvOri.Items.Count - 1
            ...
            My.Computer.FileSystem.RenameFile(txtPath.Text & "/" & lvOri.Items(i).SubItems(0).Text & lvOri.Items(i).SubItems(1).Text, lvPreview.Items(i).SubItems(0).Text & lvPreview.Items(i).SubItems(1).Text)
    ...
    Private Sub BtnUndo_Click(sender As Object, e As EventArgs) Handles BtnUndo.Click
        For i As Integer = 0 To lvOri.Items.Count - 1
            My.Computer.FileSystem.RenameFile(txtPath.Text & "\" &
                                              lvOri.Items(i).SubItems(0).Text &
                                              lvOri.Items(i).SubItems(1).Text, arrUndo(i))
