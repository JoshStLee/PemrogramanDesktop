...
Public Class Form1
    ...
    Private Sub ExportListToFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExportListToFileToolStripMenuItem.Click
    ...
    Private Sub DeleteFileToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteFileToolStripMenuItem.Click
        If lvFile.SelectedItems.Count = 1 Then
            My.Computer.FileSystem.DeleteFile(lvFile.SelectedItems(0).Tag,
    ...
    Private Sub RenameToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RenameToolStripMenuItem.Click
        Dim ext As String
        ext = Path.GetExtension(lvFile.SelectedItems(0).Tag)
        If lvFile.SelectedItems.Count = 1 Then
            My.Computer.FileSystem.RenameFile(lvFile.SelectedItems(0).Tag, InputBox("enter new name") & ext)
            GetFiles(ToolStripStatusLabel1.Text)
        End If
    End Sub
End Class
