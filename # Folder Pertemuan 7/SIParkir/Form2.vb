...
Public Class frmUtama
    ...
    Private Sub frmUtama_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim sql As String
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If hasil1.HasRows Then 'kalau sudah ada jadi keluar tapi ngebug'
                If MessageBox.Show("Keluar dari Parkir?", "Keluar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    jns = String.Empty
                End If
            Else ' kalau belum entri masuk, tapi ya semua alur programnya entah napa ke sini'
    ...
    Private Sub LogoutToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LogoutToolStripMenuItem.Click
        ...
        frmLogin.ShowDialog()
    End Sub
    Private Sub ProfilToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ProfilToolStripMenuItem.Click
        frmProfil.ShowDialog()
    End Sub
    Private Sub DaftarKendaraanToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LanggananToolStripMenuItem.Click
        frmLangganan.Show()
    End Sub
